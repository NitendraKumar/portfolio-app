            ...
            <div>
                <section className='colorlib-education' data-section='education'>
                    <div className='colorlib-narrow-content'>
                        <div className='row'>
                            <div className="col-md-6 col-md-offset-3 col-md col-lg-pull-3 animate-box animated fadeInLeft" data-animate-effect='fadeInLeft'>
                                <span className='heading-meta'> Education</span>
                                <h2 className='colorlib-heading animate-box animate fadeInUp'>Education</h2>
                            </div>
                        </div>

                        <div className='row'>
                            <div className="col-md-12 animate-box animate fadeInLeft" data-animate-effect='fadeInLeft'>
